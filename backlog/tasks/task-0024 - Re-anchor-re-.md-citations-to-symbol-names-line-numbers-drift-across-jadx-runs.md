...
Cycle-8 review: initial NO-GO (md in SOURCE_EXT let two .md cross-refs satisfy confirmed; 5b exploited it). Fixed in d0ce057: md removed, 5b downgraded to likely honestly, self-test added (proven RED on bad), TESTING.md note. Re-review GO: all 10 docs audited, every confirmed section has >=2 non-md sources, no regression.
<!-- SECTION:NOTES:END -->
