...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 js_bundle_map.md PlayNetKit row corrected: '73 ice hits' claim dropped and forward-pointed to streaming_mode.md FP-correction; F2 folded in (role text 'streaming play-mode' softened - JS bridge only names connect/createMediaDevice with {deviceId}-only params)
- [ ] #2 re-grep confirms corrected text (no surviving 'ICE 73 hits' / WebRTC-in-JS implication); just check-evidence + just secret-scan GREEN; no other re/*.md doc edited
<!-- AC:END -->
