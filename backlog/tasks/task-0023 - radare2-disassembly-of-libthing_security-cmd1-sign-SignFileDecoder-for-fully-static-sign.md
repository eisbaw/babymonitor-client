...
Cycle-12 review: qa GO (secret-hygiene clean, MD5 IV@0x76c8 verified, META-INF/BNDLTOOL.RSA present); architect NO-GO -> reconciled in 51f1e61 (4 docs superseded old needs-runtime-hook -> partially-recoverable). Re-review GO. Verdict: partially-recoverable; hash=MD5 not HMAC; cert-SHA256 offline-computable; residual=t_s.bmp token decode (TASK-0029).
<!-- SECTION:NOTES:END -->
