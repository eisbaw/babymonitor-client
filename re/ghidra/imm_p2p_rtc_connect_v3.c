// Ghidra decompilation of imm_p2p_rtc_connect_v3  (entry=00160f1c)

int imm_p2p_rtc_connect_v3
              (char *param_1,char *param_2,undefined8 param_3,undefined8 param_4,char *param_5,
              int param_6,char *param_7,undefined4 param_8,int param_9,undefined4 param_10)

{
  ...
  uVar6 = (ulong)uVar3;
  if (iVar4 == 0) {
    uVar6 = imm_p2p_log_log(4,&DAT_0023571f,0x1ca2,"connect_v3: sdk not inited\n");
    local_1150 = -1;
  }
    ...
    imm_p2p_log_log(2,&DAT_0023571f,0x1cb5,"try connect to %s, token: %.*s\n",param_1,param_6,
                    param_5);
    uStack_88 = 0;
    local_90 = 0;
    uStack_78 = 0;
    ...
    FUN_0015e3d0(auStack_10b0,0x1000,0x1000,
                 "{\"cmd\":\"connect_v3\",\"args\":{\"remote_id\":\"%s\",\"dev_id\":\"%s\",\"token\":%.*s,\"trace_id\":\"%s\",\"timeout_ms\":%d,\"lan_mode\":%d,\"preconnect_enable\":%d,\"connect_session\":\"%s\"}}"
                 ,param_1,param_2,param_6,param_5,param_7,param_9,param_8,param_10,&local_b0);
    ...
    FUN_00160208(*(undefined8 *)puVar2,"connect_v3",param_1,param_2,param_7,iVar5 - iVar4,local_114c
                );
    iVar4 = local_114c;
    if (local_114c == 0) {
      uVar6 = imm_p2p_log_log(2,&DAT_0023571f,0x1ccc,"connect to %s result %08x\n",param_1,
                              local_1150);
    }
    else {
      imm_p2p_rtc_close(local_1150,0);
      uVar6 = imm_p2p_log_log(3,&DAT_0023571f,0x1cc9,"connect to %s error %d\n",param_1,local_114c);
      local_1150 = iVar4;
    }
  }
